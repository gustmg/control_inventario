	...
	<div class="col m6 s12 l4">
		<div class="card hoverable">
			<div class="card-content center">
				...
				<span class="card-title"><b>Gust Mitre Gallardo</b></span>
				<p class="truncate">Administrator<br>gustavo.mitre.gallardo@admin.com</p>
			...
			<div class="card-action center no-padding no-select scale-transition">
            	...
            	<a href="#" class="btn-floating white z-depth-0 tooltipped" data-position="bottom" data-delay="100" data-tooltip="Eliminar usuario">
            		<i class="material-icons black-text" style="opacity: .6;">delete</i>
            	</a>
            	<a href="#" class="btn-floating white z-depth-0 tooltipped" data-position="bottom" data-delay="100" data-tooltip="Editar usuario">
